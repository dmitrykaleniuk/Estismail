    ...
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-dark bold uppercase"><?php
                echo __('Добавление платёжной системы') . ' ';
                echo __('Яндекс.Деньги');?>
            </span>
        </div>
        <div class="actions">
			<a href="https://www.estismail.com/support/202" class="btn btn-sm yellow-crusta" target="_blank">
        ...
        <form action=""
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label"><?php echo __('Номер кошелька');?>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3"><?php echo __('Секретный ключ');?>
                        <span class="required"> * </span>
                    </label>
	                <div class="col-md-6">
		                <div class="input-icon right">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-4">
                            <button  type="submit"  class="btn green tooltips" data-original-title="<?php echo __('Отправить данные');?>"><?php echo __('Готово');?></button>
                        </div>
                    </div>
                </div>
            </div>
